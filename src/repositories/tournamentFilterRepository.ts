...
export type TournamentTimePeriod = '30-days' | '3-months' | '6-months' | '1-year' | 'all';
export type TournamentSortOrder = 'date-desc' | 'date-asc' | 'size-desc' | 'size-asc';
...
const timePeriods = new Set(['30-days', '3-months', '6-months', '1-year', 'all']);
const sortOrders = new Set(['date-desc', 'date-asc', 'size-desc', 'size-asc']);
