...
- `oracle-wheel-header.png`: transparent wheel-and-pointer crop used beside
  the application title, including the wheel's full lower shadow.
...
wheel, while `index.html` uses the compact 16- and 32-pixel marks as favicons
and the 192-pixel application icon for Apple touch bookmarks.
